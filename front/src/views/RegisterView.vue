    ...
    <div class="register-container">
      ...
      <form @submit.prevent="handleRegister" class="register-form">
        ...
        <div class="section">
          ...
          <div class="form-row">
            <div class="form-group">
              <label for="region_gu">구</label>
              <input
                id="region_gu"
                v-model="formData.region_gu"
                type="text"
                placeholder="예: 강남구"
              />
            </div>
            ...
            <div class="form-group">
              <label for="region_dong">동</label>
              <input
                id="region_dong"
                v-model="formData.region_dong"
                type="text"
                placeholder="예: 역삼동"
              />
            </div>
...
const handleRegister = async () => {
  ...
  try {
    ...
    if (formData.value.region_gu) submitData.region_gu = formData.value.region_gu
    if (formData.value.region_dong) submitData.region_dong = formData.value.region_dong
