...
| 역할 | 이름 | 담당 업무 |
|:---:|:---:|:---|
| **Leader** | **이재호** | 프로젝트 총괄, 백엔드 API 설계, 추천 시스템, KOPIS 연동, UI/UX 디자인, 발표, 카카오맵 API 연동 |
| **Member** | **임경수** | 프론트엔드 개발, 컴포넌트 아키텍처, AI 검색, Composables 패턴 구현, 버그 수정 |
...
**🎉 SSAFY 14기 1학기 관통 프로젝트 - 공연 정보 플랫폼**
